...
def main():
    ...
    text = font.render(
        ...
        "a and z to zoom in/out and s and x to rotate the camera",
    ...
    c3 = pymunk.constraints.DampedSpring(space.static_body, body, (450, 300), (0, 0), 5, 1_000, 100)
    space.add(body, c3)

    body = pymunk.Body(1, 100)
    body.position = 500, 2_025
    c3 = pymunk.constraints.DampedSpring(space.static_body, body, (500, 25), (0, 0), 2_000, 1_000, 100)
    space.add(body, c3)
    ...
    while running:
        ...
        zoom_speed = 0.1
        scaling *= 1 + (zoom_speed * (zoom_in - zoom_out))
        rotation_speed = 0.1
        rotation += rotation_speed * (rotate_left - rotate_right)
