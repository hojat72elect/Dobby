...
entity_map = {(0, 0): ('player', NPC), (0, 1): ('chungu', NPC), (0, 2): ('hatrick', NPC), (0, 3): ('luna', NPC),
              (0, 4): ('george', NPC)}
item_map = {(0, 0): ('chungu', Item), (0, 1): ('hatrick', Item), (0, 2): ('luna', Item)}


def gen_hook():
    default_grass = pp.elems['Game'].gm.basic_pmap_hook('grass_e', tile_id=(0, 0), density_range=[4, 6],
                                                        grass_options=[0, 1, 2, 3, 4, 5, 6])
    wheat_grass = pp.elems['Game'].gm.basic_pmap_hook('grass_e', tile_id=(0, 1), density_range=[4, 6],
                                                      grass_options=[7, 8])
